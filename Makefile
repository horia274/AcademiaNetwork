...
build: $(PUBL)_unlinked.o Hashtable_unlinked.o Queue_unlinked.o LinkedList_unlinked.o Heap_unlinked.o
	ld -m elf_i386 -r $(PUBL)_unlinked.o Hashtable_unlinked.o Queue_unlinked.o LinkedList_unlinked.o Heap_unlinked.o -o $(PUBL).o
...
Heap_unlinked.o: Heap.h Heap.c
	$(CC) $(CFLAGS) Heap.c -c -o Heap_unlinked.o
